...
class Produits
{
    ...
    {
        // On écrit la requête
        $sql = "SELECT c.nom as categories_nom, p.id, p.nom, p.description, p.prix, p.categories_id FROM " . $this->table . " p LEFT JOIN categories c ON p.categories_id = c.id ORDER BY id DESC";
